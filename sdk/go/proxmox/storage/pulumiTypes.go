...
func (o FileSourceFilePtrOutput) Elem() FileSourceFileOutput {
	return o.ApplyT(func(v *FileSourceFile) FileSourceFile { return *v }).(FileSourceFileOutput)
}
...
func (o FileSourceRawPtrOutput) Elem() FileSourceRawOutput {
	return o.ApplyT(func(v *FileSourceRaw) FileSourceRaw { return *v }).(FileSourceRawOutput)
}
