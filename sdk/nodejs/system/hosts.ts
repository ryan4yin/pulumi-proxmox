...
export class Hosts extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:System/hosts:Hosts';
     ...
     * The host entries
     */
    public readonly entries!: pulumi.Output<outputs.System.HostsEntry[]>;
    /**
     * The hostnames
     */
    ...
    constructor(name: string, argsOrState?: HostsArgs | HostsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            if (!args || args.entries === undefined) {
...
export interface HostsState {
     ...
     * The host entries
     */
    readonly entries?: pulumi.Input<pulumi.Input<inputs.System.HostsEntry>[]>;
    /**
     * The hostnames
     */
    readonly hostnames?: pulumi.Input<pulumi.Input<pulumi.Input<string>[]>[]>;
    /**
     * The node name
     */
